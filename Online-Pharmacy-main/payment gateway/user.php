...
if(isset($_POST['submit'])){
   ...
   $sql="insert into `payment`(name,email,address,city,province,postalcode,cardname,cardno,expmonth,expyear,cvv) 
         values('$name','$email','$address','$city','$province','$postalcode','$cardname','$cardno','$expmonth','$expyear','$cvv')";
...
<div class="container">
    ...
    <form method="post">
        ...
        <div class="row">
            ...
            <div class="col">
                ...
                <div class="inputBox">
                    ...
                    <input type="text" placeholder="Enter the name" name="cardname">
                </div>
                <div class="inputBox">
                    <span>credit card number :</span>
                    <input type="number" placeholder="#### #### #### ####" name="cardno">
                </div>
                <div class="inputBox">
                    <span>exp month :</span>
                    <select class="month-input" name="expmonth">
                ...
                <div class="flex">
                    <div class="inputBox">
                        <span>exp year :</span>
                        <select   class="year-input" name="expyear">
        ...
        <input type="submit" value="Payment confamation" class="submit-btn" name="submit">
    </form>
</div>
